...
class DaemonAdmin {
    ...
    /**
     * path of PHP script in MODE_ONCE_PROC mode
     * @var string
     */
    private $run_path ;
    
    /**
     * arguments of PHP script in MODE_ONCE_PROC mode
     * @var array
     */
    private $run_path_args = [] ;
    
    /**
     * environment variable list for PHP script running in MODE_ONCE_PROC mode
     * @var array
     */
    private $run_path_env = [];
    
    /**
     * Path of PHP binary for TASK_MODE_ONCE_PROC mode
     * @var string
     */
    //private $php_bin = '/usr/bin/php';
    
    /**
     * log mode used to show more or less information in log
     * @var int
     */
...
END;
    ...
    public function getConfig($param){
        ...
        throw new \InvalidArgumentException("The param '$param' is not valid");
    }
